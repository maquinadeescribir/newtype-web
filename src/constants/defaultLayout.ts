...
// FR-TS-02: default layout ships out of box — full §5.3 tile set (18 tiles)
export const defaultLayout: TileConfig[] = [
  ...
  { type: 'breathing', size: '1x1', position: { row: 2, col: 3 }, visible: true },
  { type: 'stretch', size: '1x1', position: { row: 2, col: 4 }, visible: true },
  { type: 'read', size: '1x1', position: { row: 2, col: 5 }, visible: true },
  // Row 3
